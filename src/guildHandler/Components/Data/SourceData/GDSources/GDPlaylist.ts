...
export default class GDPlaylist extends GuildComponent implements Playlist {
	 ...
	 */
	private _getIdFromUrl(url: string): string { return url.match(/[-\w]{25,}(?!.*[-\w]{25,})/)[0]; }
	 ...
	 */
	getAllSongs(): Array<GDSong> { return this._songs; }
