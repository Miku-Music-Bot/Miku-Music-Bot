import { ipc_config, songdb_config } from '../constants/constants';
...
StartIPCServer(ipc_config.song_db_ipc_id, logger, song_db.ready, async (data: FunctionRequest<SongDBFunctions>) => {
