...
var Song = /** @class */ (function (_super) {
     ...
     */
    function Song(guildHandler, type, link, optional) {
        var _this = _super.call(this, guildHandler) || this;
        // set defaults for song
        _this.title = 'No Title';
        _this.duration = 0;
        _this.artist = 'No Artist';
        _this.thumbnailURL = "".concat(BOT_DOMAIN, "/default-thumbnail.jpg");
        _this.type = type;
        _this.link = link;
        _this.optional = optional;
        return _this;
    }
    Song.prototype.fetchData = function () {
            ...
            return __generator(this, function (_a) {
                if (this.type === 'youtube') {
                    ytdl.getInfo(this.link)
                        .then(function (info) {
                        _this.title = info.videoDetails.title;
                        _this.duration = parseInt(info.videoDetails.lengthSeconds);
                        _this.artist = info.videoDetails.author.name;
                        _this.thumbnailURL = info.thumbnail_url;
                        return;
                    })
                        .catch(function (error) {
                        _this.error("{error: ".concat(error, "} while fetching data for song with {link: ").concat(_this.link, "}"));
                        return;
                    });
                }
                return [2 /*return*/];
